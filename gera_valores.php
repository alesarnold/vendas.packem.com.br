...
$sql_extra = "INSERT INTO `pedidos_extra` (`id`, `pedido`, `revisao`, `class_prod`, `mat_auxiliar`, `cif`, `mao_obra`, `custo_bag`, `icms`, `ipi`, `pis`, `cofins`, `ir`, `csll`, `inss`, `perda`, `frete`, `comissao`, `custo_fin`, `margem`, `imposto_total`, `valor_dolar`, `cambio`, `cambio_data`, `rev_valor`) VALUES (NULL, '".$no_pedido."', '".$revisao."', '".$class_prod."', '".$valor_mat_auxiliar."', '".$valor_cif."', '".$valor_mao_obra."', '".$total."', '".$valor_icms."', '".$valor_ipi."', '".$valor_pis."', '".$valor_cofins."', '".$valor_ir."', '".$valor_csll."', '".$valor_inss."', '".$valor_perda."', '".$valor_frete."', '".$valor_comissao."', '".$valor_cfinanceiro."', '".$valor_margem."', '".$valor_imposto."', '".$valor_final_dolar."', '".$cambio_dolar."', '".$cambio_data."', '0')";
