...
if(in_array(sprintf('%05d', $row_pedidos["pedido"]), $des_especiais, true)) {
	$resumo .= '<div id="desenho_bag" style="width:357px; height:564px; background:#FFFFFF;">';
	$resumo .= '<img src="images/desenhos/'.sprintf('%05d', $row_pedidos["pedido"]).'.png" border="0">';
	$resumo .= '</div>';
} else {
	$resumo .= $desenho;
}
...
//$resumo .= $desenho;
$resumo .= '<a href="#" onclick="window.close()"><canvas id="canvas_desenho" width="357" height="564"></canvas></a>';

/*
<form name="form_desenho" action="desenho.php?pedido='.$_GET["pedido"].'" method="post">
<canvas id="canvas_desenho" width="357" height="564"></canvas>
<input type="hidden" name="desenho_input" id="desenho" value="">
<div id="desenho_div"></div>
<img id="desenho_img" src="">
</form>
*/
$resumo .= '
...
<script type="text/javascript">
	...
	html2canvas(document.querySelector("#desenho_bag"), {canvas: canvas});

	document.getElementById(\'desenho_bag\').style.display = "none";


	canvas = document.getElementById(\'canvas_desenho\');
	imageData = Canvas2Image.convertToImage(canvas, \'357\', \'564\', \'png\');

/*
	document.getElementById(\'desenho_div\').innerHTML += imageData;
	document.getElementsByName(\'desenho_input\').setAttribute("value", imageData);

/*
	document.write(imageData);
	document.getElementById(\'desenho_div\').appendChild(Canvas2Image.convertToImage(canvas, \'357\', \'564\', \'png\');
*/
